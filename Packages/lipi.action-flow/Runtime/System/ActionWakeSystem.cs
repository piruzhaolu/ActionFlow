...
namespace ActionFlow
{
    ...
    public class ActionWakeSystem : JobComponentSystem
    {
        ...
        public static void AddSleepingNode(Entity entity, ComponentType componentType, int nodeIndex)
        {
            var system = World.Active.GetOrCreateSystem<ActionWakeSystem>();

            system._sleepTypes.TryAdd(componentType, true);
